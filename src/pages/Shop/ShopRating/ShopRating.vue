        ...
        <div class="ratings-content">
            <div class="overview">
                <div class="overview-left"><h1 class="score">4.7</h1>
                    <div class="title">{{info.score}}</div>
            ...
            <div class="ratingselect">
                <div class="rating-type border-1px">
                    ...
                    </span> <span class="block negative"  @click="setSelectType(1)" :class="{active:selectType==1}">
...
<script>
    ...
    export default {
        data(){
          return {
              onlyShowText:true,//是否查看有内容的评价，默认是true
              selectType:2//选择类型 0满意 1不满意 2显示全部
          }
        },
        mounted() {
