...
<template>
  <div class="shop-header">
    ...
    <div v-if="info.supports" class="shop-header-discounts" @click="toggleSupportsShow">
    ...
    <transition name="fade">
      <div v-show="shopShow" class="shop-brief-modal">
        <div class="brief-modal-content">
          <h2 class="content-title"> <span class="content-tag"> <span class="mini-tag">品牌</span> </span> <span class="content-name">{{ info.name }}</span> </h2>
          ...
          <div class="mask-footer" @click="toggleShopShow">
            <span class="iconfont icon-close" >asdfasd</span>
          </div>
        </div>
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="supportsShow">
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li class="activity-item" v-for="(support, index) in info.supports" :key="index" :class="supportClasses[support.type]"> <span class="content-tag"> <span class="mini-tag">{{support.name}}</span> </span> <span class="activity-content">{{support.content}}</span> </li>
          </ul>
